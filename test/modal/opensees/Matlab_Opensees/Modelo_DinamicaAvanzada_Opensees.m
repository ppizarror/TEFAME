fprintf('>\tMODELO_DINAMICA_AVANZADA_OpenSees\n');

%% Creamos el modelo
modeloObj = Modelo(2, 3);
modeloObj.definirNombre('Modelo Dinamica Avanzada OpenSees');

% Configuraciones del modelamiento
modelarFundacion = false;
resolverCargasDinamicas = true;
usarDisipadores = true;

%% Nodos modelo
nodos = {};
Modelo_DinamicaAvanzadaNodo_Opensees();
...
elementos = {};
disipadores = {};
Modelo_DinamicaAvanzadaElementos_Opensees();
Modelo_DinamicaAvanzadaDisipadores_Opensees();
...
cargasDinamicas{1} = CargaRegistroSismico('Registro Constitucion L+V', {regConstitucionL, regConstitucionV}, [1, 0], 0, 200);
